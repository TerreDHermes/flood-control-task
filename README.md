...
Базовая конфигурация - каждые 25 секунд запускается функция, которая удаляет из таблицы данные, которые старше 20 секунд. То есть 20 секунд - время жизни кортежа в таблице. При условии, что показатель N < 20, зачем нам хранить данные, которые живут больще 20 секунд. Этот параметр (время жихни кортежа) можно менять в зависимости от N.
