...
Мы имеем временное окно (N), во время которого счиаем количество запросов. Поэтому, нужно как-то удалять данные, если они устарели. Чем больше данных, тем дольше мы будем отбирать нужные данные, которые укладываются во временное окно. 
